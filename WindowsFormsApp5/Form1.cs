...
namespace Game248
{
    public partial class Form1 : Form
    {
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            labelMax.Text = DateTime.Now.Millisecond.ToString();
        ...
        private void StartGame()
        {
            ...
            while (n1 == n2);
            board[n1 / N, n1 % N] = rnd.Next(2) * 2 + 2; 
        ...
        private void generateNewData()
        {
            ...
            board[nCount / N, nCount % N] = rnd.Next(2) * 2 + 2; 
        }
        ...
        {
            gameMode = Convert.ToInt32(comboBox1.Text);
            RefreshAllButtons();
        }
    }
}
